...
delta = (wl2-wl1)/nth;
eta_L0=eta_Sio_2(632);%TiO20=eta_Sio_2(550);
    eta_H0=eta_Tio_2(632);%TiO20=eta_Tio_2(550);
    eta_L0=eta_L0;
    eta_H0=eta_H0;
    d_L=4480.0;
    d_H=1546.4;
...
for i=1:1
    ...
    ep=[2.25,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,eps_H,eps_L,1.0];
d=[d_L*4,d_H,d_L,d_H,d_L,d_H,d_L,d_H,d_L,d_H,d_L,d_H,d_L,d_H,d_L,d_H,d_L*5];
...
% d_L=1082;
  ...
  save REFSBSW640.txt REFS -ascii  
